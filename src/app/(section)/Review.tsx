...
//         />
//       </div>
//       <div className="absolute -top-10 left-0 z-0 md:top-52">
//         <Image
//           src={"/images/home/review/bgr1.png"}
//           width={281}
//           height={74}
//           alt="image1"
...
//         <div className="line"></div>
//       </div>
//       <div className="z-40 flex h-full w-full flex-col items-center justify-center gap-4 rounded-t-full py-12 md:py-44 md:pt-24">
...
//               whileInView="visible"
//               viewport={{ amount: 0.5 }}
//               className="text-center font-oswald text-4xl font-[400] uppercase tracking-[3px] text-[#079EBC] md:text-7xl md:tracking-[4px]"
//             >
...
//                           <p className="w-full max-w-[350px] text-center font-poppins text-sm font-[500] uppercase tracking-[2px] text-[#000] md:px-4 lg:leading-[120%]">
//                             {review.text.text}
//                           </p>
//                         </div>
...
//                           />
//                           <p className="w-full max-w-[350px] text-center font-poppins text-sm font-[500] uppercase tracking-[2px] text-[#595959] md:px-4 lg:leading-[120%]">
...
//                 <CarouselPrevious className="border-[#079EBC] text-[#079EBC] transition-transform duration-300 ease-in-out group-hover:-translate-x-2" />
//                 <CarouselNext className="border-[#079EBC] text-[#079EBC] transition-transform duration-300 ease-in-out group-hover:translate-x-2" />
//               </div>
//             </Carousel>
//           )}
//         </div>
                      ...
                      >
                        <div className="flex flex-col gap-3 bg-transparent px-6 pb-4 md:pb-6">
                          ...
                          <div className="flex flex-col gap-2 pt-4 md:pt-6">
                            <p
                              className={`w-full max-w-[350px] text-center font-poppins text-sm font-[500] uppercase tracking-[2px] text-[#000] md:px-4 lg:leading-[120%] ${
                            ...
                            {review.text.text.length > 150 && (
                              <button
                                ...
                                className="text-xs font-semibold text-[#079EBC] hover:underline"
                              >
